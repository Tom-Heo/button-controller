...
5. 사용자가 버튼을 누르면 편집 기능(action: edit)을 사용하여 해당 메시지의 버튼을 제거한다.
...
- 사용자가 버튼을 클릭하면 해당 버튼형 메시지의 버튼은 제거한다.
- 버튼의 style은 선택의 무게를 반영한다.
...
- 사용자가 버튼을 눌렀음에도 해당 메시지의 버튼을 제거하지 않는 실수. 사용자가 버튼을 누르면 해당 메시지의 버튼은 Telegram의 편집 기능(action: edit)으로 제거해야 한다. 편집 시 수신자(target)를 누락하지 않도록 주의해야 한다.
- 버튼형 메시지의 버튼만 제거해야 하는데 메시지 자체를 삭제하는 실수. 사용자가 버튼을 클릭하면 Telegram의 편집 기능(action: edit)으로 해당 메시지의 버튼만 제거해야 한다. 편집 시 수신자(target)를 누락하지 않도록 주의해야 한다.
